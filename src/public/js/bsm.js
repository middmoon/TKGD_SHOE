    ...
    !function(a) {
        ...
        e.prototype = {
            ...
            createLi: function() {
                ...
                return this.$element.find("option").each(function(b) {
                    ...
                    !c.hasClass("bs-title-option")) {
                        ...
                        "OPTGROUP" === this.parentNode.tagName && c.data("divider") !== !0) {
            ...
            keydown: function(c) {
                ...
                !l && (c.keyCode >= 48 && c.keyCode <= 57 || c.keyCode >= 96 && c.keyCode <= 105 || c.keyCode >= 65 && c.keyCode <= 90) && (o.options.container ? o.$newElement.trigger("click") : (o.setSize(),
